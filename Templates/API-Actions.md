...
Creates a new [`Action`](API-Actions.md#-action-) object.
...
For some action types, this information may be in the [`List List { get; }`](API-Actions.md#-list-list-get-)
            or [`List OldList { get; }`](API-Actions.md#-list-oldlist-get-) properties.
...
For some action types, this information may be in the [`List ListAfter { get; }`](API-Actions.md#-list-listafter-get-)
            or [`List ListBefore { get; }`](API-Actions.md#-list-listbefore-get-) properties.
...
Enumerates known types of [`Action`](API-Actions.md#-action-)s.
